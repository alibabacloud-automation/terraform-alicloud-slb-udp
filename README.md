Alibaba Cloud Load Balancer (SLB) UDP Terraform Module
terraform-alicloud-slb-udp
=====================================================================

English | [简体中文](https://github.com/terraform-alicloud-modules/terraform-alicloud-slb-udp/blob/master/README-CN.md)

Terraform Module for creating UDP Load Balancer on Alibaba Cloud.
...
* [Basic example](https://github.com/terraform-alicloud-modules/terraform-alicloud-slb-udp/tree/master/examples/basic-example)
